...
{  // cout<<"  InoOldTrackFitAlg::InoOldTrackFitAlg() " <<endl;
 ...
 ZPosLayer[11]=   paradef->GetParroom(2);//Building height
...
void InoOldTrackFitAlg::RunTheFitter_new( ) {
 ...
 cout<<"Called GoForwards_new(false); first time:  "<<endl;
	...
	//.......................................CMVD Extrapolation..............................
	if(LastIteration){
	cout<<"Extrapolation to CMVD in InoTrackFit Alg: "<<endl;
			...
			bool GetPrediction=Swim_new(x_k_minus_copy, xvtx_para, MaxPlane, NPlane, true, &ds, &drange);
			...
			xvtx_parameter[5] =1.e+3*zexppos;// ZPosLayer[NPlane];
	...
	///////////////////////////////
			...
			bool GetRoofPrediction=Swim_new(x_k_minus_copy, xvtx_para_roof, MaxPlane, BuildPlane, true, &ds, &drange);
